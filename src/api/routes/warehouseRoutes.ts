...
router.post("/", adminOnly, validate(createWarehouseSchema), warehouseController.createWarehouse);
router.put("/:id", adminOnly, validate(updateWarehouseSchema), warehouseController.updateWarehouse);
