...
#define PIN_VBAT_SENSE      3
#define PIN_ADAPTER_PRESENT 2
#define PIN_DOOR_SWITCH     4
#define PIN_SIREN           7
#define PIN_SIM800L_TX      43
#define PIN_SIM800L_RX      44
...
static constexpr uint32_t SIREN_ON_MS      = 30000;
static constexpr uint32_t ALARM_COOLDOWN_MS = 30000;
static constexpr uint32_t VBAT_READ_INTERVAL_MS        = 10000;
static constexpr uint32_t POST_SIREN_SETTLE_MS         = 5000;
static constexpr uint32_t POST_SOURCE_CHANGE_SETTLE_MS = 2000;
static constexpr float    V_BAT_IMPLAUSIBLE            = 4.35f;
static constexpr float    V_LOW_ENTER                  = 3.60f;
static constexpr float    V_LOW_EXIT                   = 3.65f;
static constexpr float    V_CRIT_ENTER                 = 3.40f;
static constexpr float    V_CRIT_EXIT                  = 3.45f;
static constexpr uint8_t  VBAT_MEDIAN_N                = 15;
...
static uint32_t sourceChangeMs     = 0;
...
static float readBatteryMedian() {
  ...
  return samples[VBAT_MEDIAN_N / 2];
}
static void readBatteryVoltage() {
  ...
  static constexpr float DIV_RATIO = 2.251f;
  static constexpr float VBAT_K    = 0.972f;
